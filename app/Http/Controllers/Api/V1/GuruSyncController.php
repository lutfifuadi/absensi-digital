...
class GuruSyncController extends BaseSyncController
{
    ...
    /**
     * Handle incoming sync request for Guru.
     */
    public function sync(Request $request)
    {
        ...
        try {
            $guru = $this->syncService->syncGuru($payload);
            return $this->sendResponse($guru, 'Data Guru berhasil disinkronisasi.', 200);
        } catch (\Exception $e) {
