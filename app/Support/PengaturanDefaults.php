...
class PengaturanDefaults
{
    ...
    public static function definitions(): array
    {
        ...
        self::$definitions = [
            ...
            'jam_mulai_absensi_guru' => ['default' => '06:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Mulai Absensi Guru Pengajar', 'description' => 'Mulai scan guru', 'icon' => 'tabler-clock-play', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_masuk_guru' => ['default' => '07:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Masuk Guru Pengajar', 'description' => 'Target masuk guru', 'icon' => 'tabler-clock', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_batas_masuk_guru' => ['default' => '08:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Batas Akhir Jam Masuk Guru Pengajar', 'description' => 'Batas late guru', 'icon' => 'tabler-clock-stop', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_pulang_guru' => ['default' => '15:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Pulang Guru Pengajar', 'description' => 'Target pulang guru', 'icon' => 'tabler-clock-check', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_akhir_pulang_guru' => ['default' => '17:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Batas Akhir Absen Pulang Guru Pengajar', 'description' => 'Selesai scan pulang guru', 'icon' => 'tabler-clock-off', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_mulai_pulang_guru' => ['default' => '14:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Mulai Absen Pulang Guru Pengajar', 'description' => 'Mulai scan pulang guru', 'icon' => 'tabler-clock-down', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'toleransi_guru' => ['default' => '15', 'type' => 'int', 'group' => 'umum', 'label' => 'Toleransi Guru Pengajar (Menit)', 'description' => 'Toleransi menit guru', 'icon' => 'tabler-hourglass', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],

            // ─── JAM ABSENSI STAFF TATA USAHA / TENDIK ────────────────────────
            'jam_mulai_absensi_staff' => ['default' => '06:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Mulai Absensi Staff TU', 'description' => 'Mulai scan staff', 'icon' => 'tabler-clock-play', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_masuk_staff' => ['default' => '07:30', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Masuk Staff TU', 'description' => 'Target masuk staff', 'icon' => 'tabler-clock', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_batas_masuk_staff' => ['default' => '08:30', 'type' => 'string', 'group' => 'umum', 'label' => 'Batas Akhir Jam Masuk Staff TU', 'description' => 'Batas late staff', 'icon' => 'tabler-clock-stop', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_pulang_staff' => ['default' => '16:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Pulang Staff TU', 'description' => 'Target pulang staff', 'icon' => 'tabler-clock-check', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_akhir_pulang_staff' => ['default' => '18:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Batas Akhir Absen Pulang Staff TU', 'description' => 'Selesai scan pulang staff', 'icon' => 'tabler-clock-off', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'jam_mulai_pulang_staff' => ['default' => '15:00', 'type' => 'string', 'group' => 'umum', 'label' => 'Jam Mulai Absen Pulang Staff TU', 'description' => 'Mulai scan pulang staff', 'icon' => 'tabler-clock-down', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            'toleransi_staff' => ['default' => '15', 'type' => 'int', 'group' => 'umum', 'label' => 'Toleransi Staff TU (Menit)', 'description' => 'Toleransi menit staff', 'icon' => 'tabler-hourglass', 'is_toggle' => false, 'tenant_scoped' => false, 'permission' => 'admin_sekolah'],
            ...
            'wa_template_rekap_presensi' => [
                ...
                'description'   => 'Template default teks rekapitulasi presensi mapel untuk WhatsApp.',
                'icon'          => 'tabler-message-text',
                'is_toggle'     => false,
                'tenant_scoped' => false,
                'permission'    => 'admin_sekolah',
            ],
