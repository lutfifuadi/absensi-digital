...
class NotificationTemplate extends Model
{
    ...
    public const TYPES = [
        'hadir_masuk' => 'Hadir Tepat Waktu (Siswa)',
        'terlambat_masuk' => 'Hadir Terlambat (Siswa)',
        'sakit_masuk' => 'Izin Sakit (Siswa)',
        'izin_masuk' => 'Izin Keperluan (Siswa)',
        'alpha_masuk' => 'Tidak Hadir/Alpha (Siswa)',
        'pulang' => 'Informasi Kepulangan (Siswa)',
        'guru_hadir_masuk' => 'Presensi Guru — Hadir Tepat Waktu',
        'guru_terlambat_masuk' => 'Presensi Guru — Hadir Terlambat',
        'guru_sakit_masuk' => 'Presensi Guru — Izin Sakit',
        'guru_izin_masuk' => 'Presensi Guru — Izin Keperluan',
        'guru_alpha_masuk' => 'Presensi Guru — Tidak Hadir (Alpha)',
        'guru_pulang' => 'Presensi Guru — Informasi Kepulangan',
