...
class FixDuplikatWaliKelas extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($guruWaliBaru as $guruBaru) {
            ...
            // Minimum threshold: 85% — sangat ketat untuk menghindari false match!
            $threshold = 85;
     ...
     *
     * Strategi:
     * 1. Jika setelah normalisasi kedua nama SAMA PERSIS → 100%
     * 2. Jika semua kata dari nama pendek ada di nama panjang (subset) → 100%
     * 3. Jika kata pertama (nama depan) sama DAN kata terakhir (nama belakang) sama → 95%
     * 4. Jika hanya kata pertama sama dan similaritas tinggi → 85-95%
     * 5. Selain itu → skor similar_text murni (tanpa bonus)
     */
