                    ...
                    <ul class="dropdown-menu dropdown-menu-end das-modal border-0 shadow-lg" style="min-width: 250px;">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2 py-2 px-3 text-white-50 hover-bg-primary-light" href="javascript:void(0)" id="btnCheckWaAllDatabase">
                                ...
                                <div>
                                    <div class="fw-bold text-white small">Cek Massal Semua Guru</div>
                                    <div class="extra-small text-white-50">Validasi seluruh guru via progress</div>
                                </div>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content das-modal das-modal--danger shadow-lg">
                <div class="das-modal__head das-modal__head--danger">
                    <h5 class="das-modal__title"><i class="ti tabler-alert-triangle me-2"></i> Hapus Semua Guru</h5>
                </div>
                <form id="deleteAllForm" action="{{ route('admin.guru.destroy-all') }}" method="POST">
                    ...
                    <div class="das-modal__body text-center p-4">
                        ...
                        <p class="dev-confirm-message__main">Apakah Anda yakin ingin menghapus SELURUH data guru?</p>
                        <p class="dev-confirm-message__warning text-start">
                            <i class="ti tabler-info-circle"></i>
                            <span>Semua data guru akan dihapus permanen, termasuk akun user terkait. Tindakan ini tidak dapat dibatalkan.</span>
                        </p>
...
@section('page-script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (btnRegeneratePhoneGuru) {
                btnRegeneratePhoneGuru.addEventListener('click', function() {
                    Swal.fire({
                        ...
                        html: `<div class="mt-2 text-white-50">Format seluruh nomor WA Guru (08...) akan dikonversi ke standar internasional (<b class="text-success">628...</b>).</div>`,
                        icon: 'question',
                        showCancelButton: true,
            ...
            // ═══════════════════════════════════════════════════════════════
            // BATCH WA VALIDITY CHECKER FOR GURU TABLE
            // ═══════════════════════════════════════════════════════════════
                        ...
                        if (data.status) {
                            ...
                            if (offset < total && data.processed > 0) {
                                ...
                                Swal.fire({
                                    ...
                                    text: `Selesai memverifikasi seluruh ${total} data guru. Ditemukan ${validTotal} nomor terdaftar di WhatsApp.`,
