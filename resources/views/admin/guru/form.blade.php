            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <input id="mata_pelajaran" name="mata_pelajaran" type="text"
                  ...
                  placeholder="Contoh: Matematika, B. Inggris" value="{{ old('mata_pelajaran', $guru->mata_pelajaran) }}"
                  required>
              </div>
              ...
              <div class="col-md-6">
                ...
                <select id="status" name="status" class="form-select @error('status') is-invalid @enderror"
                  ...
                  <option value="nonaktif" {{ old('status', $guru->status) === 'nonaktif' ? 'selected' : '' }}>Nonaktif
                  </option>
                </select>
              </div>
              ...
              <div class="col-12 mt-4">
                ...
                <h6 class="text-info fw-bold mb-3 d-flex align-items-center gap-2">
                  <i class="ti tabler-lock fs-5"></i> Akses Akun Guru
                </h6>
              </div>
              ...
              @if (isset($user))
                <div class="col-md-12">
                  <div class="alert alert-info mb-0" role="alert">
                    Profil guru akan dibuat untuk akun login:
