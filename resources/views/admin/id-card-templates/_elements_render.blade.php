...
<div class="element text" style="
    left: {{ ($elements['name']['align'] ?? 'center') == 'center' ? 0 : $elements['name']['x'] . 'pt' }}; 
    top: {{ $elements['name']['y'] }}pt;
    width: {{ ($elements['name']['align'] ?? 'center') == 'center' ? '100%' : 'auto' }};
    text-align: {{ $elements['name']['align'] ?? 'center' }};
...
<div class="element text" style="
    left: {{ ($elements['class']['align'] ?? 'center') == 'center' ? 0 : $elements['class']['x'] . 'pt' }}; 
    top: {{ $elements['class']['y'] }}pt;
    width: {{ ($elements['class']['align'] ?? 'center') == 'center' ? '100%' : 'auto' }};
    text-align: {{ $elements['class']['align'] ?? 'center' }};
