...
@section('content')
      ...
      <div class="das-hero__identity">
        ...
        <div class="das-hero__meta">
          <div class="das-hero__badge">
            ...
            <a href="{{ route('admin.pelanggaran-jenis.index') }}" class="text-white text-decoration-none">Jenis Pelanggaran</a> / Tambah
          </div>
          <h4 class="das-hero__title text-gradient-gold">Tambah Jenis Pelanggaran</h4>
          <p class="das-hero__subtitle">Buat butir pelanggaran baru dan tetapkan bobot poinnya.</p>
        </div>
      </div>
  ...
  <div class="das-panel">
    <div class="das-panel__header border-bottom py-3 px-4" style="border-color:rgba(255,255,255,0.08) !important;">
      <h6 class="das-panel__title mb-0 text-white"><i class="ti tabler-plus me-1 text-warning"></i> Formulir Tambah Jenis Pelanggaran</h6>
    </div>
    <div class="das-panel__body p-4 text-white">
      <form action="{{ route('admin.pelanggaran-jenis.store') }}" method="POST">
        @csrf
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="number" name="bobot_poin" id="bobot_poin" class="form-control" min="1" max="100" value="{{ old('bobot_poin', 5) }}" required placeholder="Contoh: 10">
          </div>
        </div>

        <div class="mb-3">
          <label for="nama" class="form-label">Nama Pelanggaran <span class="text-danger">*</span></label>
          <input type="text" name="nama" id="nama" class="form-control" value="{{ old('nama') }}" required placeholder="Contoh: Terlambat masuk kelas, Tidak memakai atribut seragam lengkap">
        </div>

        <div class="mb-3">
          <label for="deskripsi" class="form-label">Deskripsi / Penjelasan Pelanggaran</label>
          <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" placeholder="Tulis deskripsi opsional mengenai pelanggaran ini...">{{ old('deskripsi') }}</textarea>
        </div>
        ...
        <div class="d-flex gap-2">
          <button type="submit" class="btn btn-primary"><i class="ti tabler-device-floppy me-1"></i> Simpan Data</button>
