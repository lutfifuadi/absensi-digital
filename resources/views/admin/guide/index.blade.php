...
@section('page-style')
  <style>
    ...
    .das-hero__icon-wrapper { position: relative; }
    .das-hero__icon {
      width: 64px;
      height: 64px;
    ...
    .das-table-btn--success:hover { color: var(--das-success); border-color: var(--das-success); }
...
@section('content')
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1" style="font-size:0.65rem; text-transform:uppercase; letter-spacing:1px; opacity:0.6;">
              ...
              <li class="breadcrumb-item active text-white opacity-100">Manajemen Panduan</li>
            </ol>
          </nav>
          <h4 class="das-hero__title">Manajemen Panduan</h4>
          <p class="das-hero__welcome">Kelola artikel panduan pengguna, konten bantuan, dan dokumentasi fitur.</p>
        </div>
      </div>

      <div class="das-hero__actions">
        <a href="{{ route('admin.guides.create') }}" class="das-btn das-btn--primary shadow-sm">
          <i class="ti tabler-plus me-1"></i> Tambah Panduan Baru
        </a>
      </div>
    </div>
  </div>
  ...
  <div class="das-panel slide-in-up">
    <div class="das-panel__head flex-wrap gap-3">
      ...
      <div class="d-flex align-items-center gap-3 flex-grow-1 justify-content-md-end flex-wrap">
        <div class="position-relative flex-grow-1 flex-md-grow-0" style="max-width: 220px;">
        ...
        <select id="categoryFilter" class="filter-select form-select w-auto">
        ...
        <select id="statusFilter" class="filter-select form-select w-auto">
        ...
        <span class="das-chip das-chip--info d-none d-sm-inline-flex" id="totalCount">{{ $guides->total() }} Total</span>
      </div>
    </div>

    <div id="guideTableContainer">
      @include('admin.guide.table')
    </div>
  </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content das-modal shadow-lg">
        <div class="das-modal-head d-flex align-items-center justify-content-between" style="background: rgba(234,84,85,0.05);">
          <h5 class="das-modal-title"><i class="ti tabler-alert-triangle me-2 text-danger"></i>Hapus Panduan</h5>
          ...
          <div class="das-modal-body text-center">
            <div class="mb-4">
              <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                ...
                <i class="ti tabler-book-off text-danger fs-1"></i>
              </div>
              <h4 class="text-white mb-2">Hapus <span id="delName" class="text-danger"></span>?</h4>
              <p class="text-muted small">Panduan akan dipindahkan ke tempat sampah (soft delete). Anda masih bisa memulihkannya nanti.</p>
            </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function fetchData(page = 1) {
        ...
        const url = `{{ route('admin.guides.index') }}?page=${page}&search=${encodeURIComponent(search)}&category_id=${categoryId}&status=${status}&per_page=${perPage}`;
