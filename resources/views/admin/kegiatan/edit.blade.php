        ...
        <div class="row g-4">
          ...
          <div class="col-md-6">
            ...
            <select name="target_gender" class="form-select das-form-control">
              <option value="" {{ old('target_gender', $kegiatan->target_gender) === null || old('target_gender', $kegiatan->target_gender) === '' ? 'selected' : '' }}>Semua Jenis Kelamin</option>
          ...
          <div class="col-12">
            ...
            <div class="row g-2 p-3 mb-3" style="background:rgba(255,255,255,0.02); border:1px solid var(--das-border); border-radius:var(--das-radius);">
              @foreach($kelas as $k)
                <div class="col-md-2 col-6 checkbox-kelas-wrapper" data-tingkat="{{ $k->tingkat }}" data-jurusan="{{ $k->jurusan?->nama ?? '' }}">
                  <div class="form-check">
