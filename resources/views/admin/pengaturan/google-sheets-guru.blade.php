...
@section('title', 'Pengaturan Google Sheets Guru')
  ...
  <div class="set-hero__inner">
    <div class="set-hero__identity">
      ...
      <div>
        ...
        <h4 class="set-hero__title text-gradient-gold">Pengaturan Google Sheets Guru</h4>
        <p class="set-hero__sub">Konfigurasi koneksi Google Sheets untuk sinkronisasi data guru dan pengguna.</p>
      </div>
    </div>
    <div class="set-hero__breadcrumb glass-card">
      ...
      <span class="small text-white fw-semibold">Google Sheets Guru</span>
    </div>
  </div>
</div>
    ...
    <div style="display:flex;flex-direction:column;gap:1rem;">
      ...
      <div style="display:flex;align-items:flex-start;gap:0.75rem;padding:0.75rem 1rem;background:rgba(40,199,111,0.06);border:1px solid rgba(40,199,111,0.15);border-radius:6px;">
        ...
        <div>
          ...
          <div style="font-size:0.72rem;color:#94a3b8;line-height:1.5;">
            Gunakan tombol <strong>Test Koneksi</strong> untuk memastikan semuanya berfungsi. Jika berhasil, klik <strong>Sinkron Sekarang</strong> untuk menarik data guru dari Google Sheets. Proses sinkron berjalan di latar belakang — status bisa dicek di panel <strong>Status Sinkronisasi</strong> setelah halaman di-reload.
          </div>
        </div>
      </div>
    </div>
    ...
    <main class="set-content">
      <div class="gs-grid-container">
        ...
        <div class="gs-grid-left">
          <form action="{{ route('admin.pengaturan.google-sheets-guru.update') }}" method="POST" id="gsUpdateForm">
            @csrf
              ...
              <div class="set-panel__body">
                ...
                <div class="set-form-grid">
                  ...
                  <div class="set-field set-field--full">
                    ...
                    <div id="column_mapping_help" class="text-muted small mt-1">Mapping kolom Google Sheets ke field database. Format: {"nip":"NIP","nama_lengkap":"Nama Lengkap","jenis_kelamin":"Jenis Kelamin","mata_pelajaran":"Mata Pelajaran","jabatan":"Jabatan","no_hp":"No HP"}</div>
            ...
            <div class="set-panel__body">
              <div class="gs-action-list">
                ...
                <div class="gs-action-item">
                  ...
                  <form action="{{ route('admin.pengaturan.google-sheets-guru.sync-now') }}" method="POST" id="gsSyncNowForm" class="m-0">
                    @csrf
 ...
 * Memanggil route admin.pengaturan.google-sheets-guru.template.create
 */
  ...
  try {
    ...
    if (result.success) {
      ...
      Swal.fire({
        ...
        html: '<div style="text-align:center">Google Sheet template telah berhasil dibuat dengan 6 kolom otomatis.</div>',
 ...
 * Memanggil route admin.pengaturan.google-sheets-guru.preview-mapping
 */
