                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-start gap-3">
                      ...
                      <div>
                        ...
                        <div class="text-muted small">Jika diaktifkan, setiap ada penambahan, pengubahan, atau penghapusan data guru di aplikasi, Google Sheet akan diperbarui secara otomatis di latar belakang.</div>
                      </div>
                    </div>
                    <div class="form-check form-switch ms-3" style="font-size: 1.25rem;">
                      <input class="form-check-input" type="checkbox" role="switch" id="auto_sync_on_change_guru" name="auto_sync_on_change" value="1" {{ old('auto_sync_on_change', $guruSetting->auto_sync_on_change ?? false) ? 'checked' : '' }} style="cursor: pointer;">
                    </div>
                  </div>
                </div>
              </div>
