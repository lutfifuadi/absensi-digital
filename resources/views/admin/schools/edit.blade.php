...
@section('title', 'Edit Sekolah — SaaS')
  ...
  <div class="das-hero__inner">
    <div class="das-hero__identity">
      ...
      <div class="das-hero__meta">
        ...
        <h4 class="das-hero__title text-gradient-gold">Edit: {{ $school->name }}</h4>
        <p class="das-hero__subtitle">Perbarui informasi dasar dan pengaturan akses untuk tenant ini.</p>
      </div>
    </div>
    ...
    <div class="das-panel bounce-in">
      <div class="das-panel__head">
        <div class="das-panel__title">
          ...
          Identitas & Akses Tenant
        </div>
        <div class="das-chip --primary">KODE: {{ $school->unique_code }}</div>
      </div>
          ...
          <div class="row gy-3">
            <div class="col-12">
              ...
              <div class="input-group input-group-merge border-0 shadow-sm">
                ...
                <input type="text" class="form-control bg-label-dark border-0 text-white" id="name" name="name" value="{{ $school->name }}" required />
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <div class="input-group input-group-merge border-0 shadow-sm">
                ...
                <input type="text" id="subdomain" name="subdomain" class="form-control bg-label-dark border-0 text-white" value="{{ $school->subdomain }}" required />
            ...
            <div class="col-12">
              ...
              <div class="input-group input-group-merge border-0 shadow-sm">
                ...
                <input type="email" id="email" name="email" class="form-control bg-label-dark border-0 text-white" value="{{ $school->email }}" />
              </div>
            </div>
          </div>
