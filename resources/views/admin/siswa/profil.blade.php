...
<div class="das-hero das-hero--with-stats mb-4">
  ...
  <div class="das-hero__inner">
    ...
    <div class="das-hero__actions d-flex gap-2">
      <a href="{{ route('admin.siswa.generate-qr', $siswa->id) }}" class="das-btn das-btn--info">
        <i class="ti tabler-qrcode"></i> Cetak Kartu
      </a>
      <a href="{{ route('admin.siswa.edit', $siswa->id) }}" class="das-btn das-btn--primary">
...
<div class="row">
  <div class="col-xl-4 col-lg-5">
    ...
    <div class="das-panel mb-4">
      ...
      <div class="das-panel__body d-grid gap-2">
        <button class="das-btn das-btn--warning w-100" data-bs-toggle="modal" data-bs-target="#modalPindahKelas">
          <i class="ti tabler-arrows-exchange"></i> Pindah Kelas
        </button>
        <button class="das-btn das-btn--success w-100" data-bs-toggle="modal" data-bs-target="#modalNaikKelas">
