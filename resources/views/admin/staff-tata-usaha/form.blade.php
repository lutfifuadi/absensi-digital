      ...
      @if ($staff->exists)
        <div class="card border-0 shadow-sm mt-4"
          ...
          <div class="card-header border-bottom py-3 d-flex align-items-center gap-2"
            ...
            <h6 class="card-title mb-0">Dual QR Code Staff (ID Unik & NIP)</h6>
          </div>
          <div class="card-body p-4">
            <div class="row g-4">
              ...
              <div class="col-md-6">
                <div class="p-3 rounded-3 h-100 d-flex align-items-center gap-3"
                  ...
                  <div class="bg-white p-2 rounded shadow-sm flex-shrink-0">
                    <img src="{{ App\Support\QrCodeGenerator::renderDataUri($staff->qr_code ?? App\Support\QrCodeGenerator::generate('STAFF'), 110) }}"
                  ...
                  <div>
                    ...
                    <code class="px-2 py-1 rounded bg-label-info text-info fw-bold extra-small text-break">{{ $staff->qr_code }}</code>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="p-3 rounded-3 h-100 d-flex align-items-center gap-3"
                  style="background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.05);">
                  <div class="bg-white p-2 rounded shadow-sm flex-shrink-0">
                    <img src="{{ App\Support\QrCodeGenerator::renderDataUri($staff->qr_code_nip ?? $staff->nip, 110) }}"
                  ...
                  <div>
                    ...
                    <p class="text-white-50 extra-small mb-2">Kode QR berbasis NIP resmi staff yang langsung dapat di-scan oleh sistem.</p>
                    <code class="px-2 py-1 rounded bg-label-success text-success fw-bold extra-small text-break">{{ $staff->qr_code_nip ?? $staff->nip }}</code>
                  </div>
                </div>
              </div>
            </div>
