...
@section('title', 'Ubah Data Orang Tua')
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1" style="font-size:.65rem;text-transform:uppercase;letter-spacing:1px;opacity:.6;">
              ...
              <li class="breadcrumb-item active text-white opacity-100">Ubah</li>
            </ol>
          </nav>
          <h4 class="das-hero__title">Ubah Data Orang Tua</h4>
          <p class="das-hero__welcome">Perbarui biodata diri, akun login, serta koneksi siswa yang terhubung.</p>
        </div>
      </div>
  ...
  <form action="{{ route('admin.orang-tua.update', $orangTua->id) }}" method="POST">
    ...
    <div class="das-panel slide-in-up">
      <div class="das-panel__head">
        ...
        <span class="das-chip das-chip--info">ID: {{ $orangTua->id }}</span>
      </div>
      ...
      <div class="das-panel__body">
        <div class="row g-4">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="username" value="{{ old('username', $orangTua->username) }}"
          ...
          {{-- Password Baru --}}
          <div class="col-md-6">
            <label class="das-form-label">Password Baru <small class="text-muted" style="font-size:.65rem;text-transform:none;">(Kosongkan jika tidak diubah)</small></label>
            <input type="password" name="password"
                   class="form-control das-form-control @error('password') is-invalid @enderror" placeholder="Minimal 6 karakter">
          </div>

          {{-- Konfirmasi Password --}}
          <div class="col-md-6">
            <label class="das-form-label">Konfirmasi Password Baru</label>
            <input type="password" name="password_confirmation"
                   class="form-control das-form-control" placeholder="Ulangi password baru">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="das-panel__body">
        ...
        <div class="d-flex justify-content-end gap-2 mt-4 pt-3" style="border-top:1px solid var(--das-border);">
          ...
          <button type="submit" class="das-btn das-btn--primary px-4">
            <i class="ti tabler-device-floppy"></i> Perbarui Data Orang Tua
          </button>
        </div>
      </div>
    </div>
