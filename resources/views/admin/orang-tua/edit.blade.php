            ...
            <div class="das-hero__identity">
                <div class="das-hero__logo-wrapper">
                    <div class="das-hero__logo-placeholder">
                        <i class="ti tabler-pencil text-info"></i>
                    </div>
                ...
                <div class="das-hero__meta">
                    <div class="das-hero__badge">
                        ...
                        <a href="{{ route('admin.master-data') }}" class="text-white text-decoration-none">Master Data</a> / <a href="{{ route('admin.orang-tua.index') }}" class="text-white text-decoration-none">Orang Tua</a> / Ubah
                    </div>
                    <h4 class="das-hero__title text-gradient-gold">Ubah Data Orang Tua</h4>
                    <p class="das-hero__subtitle">Perbarui data diri, username, email, password, serta siswa yang terhubung.</p>
                </div>
            </div>
        ...
        <div class="col-12">
            ...
            <div class="das-panel">
                <div class="das-panel__header border-bottom py-3 px-4 d-flex align-items-center gap-2"
                    ...
                    <h6 class="das-panel__title mb-0 text-white">Form Perubahan Orang Tua</h6>
                </div>
                <div class="das-panel__body p-4">
                    <form action="{{ route('admin.orang-tua.update', $orangTua->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="name" name="name" type="text"
                                    ...
                                    placeholder="Masukkan nama lengkap" value="{{ old('name', $orangTua->name) }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="no_hp" name="no_hp" type="text"
                                    ...
                                    style="background-color:rgba(255,255,255,0.05) !important;"
                                    placeholder="Contoh: 081234567890" value="{{ old('no_hp', $orangTua->no_hp) }}">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="hubungan" name="hubungan" class="form-select text-white bg-transparent border-white-10 @error('hubungan') is-invalid @enderror" style="background-color:rgba(255,255,255,0.05) !important;" required>
                                    ...
                                    <option value="Lainnya" {{ old('hubungan', $orangTua->hubungan) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="status" name="status" class="form-select text-white bg-transparent border-white-10 @error('status') is-invalid @enderror" style="background-color:rgba(255,255,255,0.05) !important;" required>
                                    <option value="aktif" {{ old('status', $orangTua->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="nonaktif" {{ old('status', $orangTua->status) == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <h6 class="text-white fw-bold mb-1"><i class="ti tabler-lock me-1 text-primary"></i> Akun Login</h6>
                                <p class="text-white-50 small mb-3">Kosongkan password jika tidak ingin diubah.</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="username" name="username" type="text"
                                    ...
                                    style="background-color:rgba(255,255,255,0.05) !important;"
                                    placeholder="Username untuk login" value="{{ old('username', $orangTua->username) }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="email" name="email" type="email"
                                    ...
                                    style="background-color:rgba(255,255,255,0.05) !important;"
                                    placeholder="email@example.com" value="{{ old('email', $orangTua->email) }}" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-white" for="password">
                                    <i class="ti tabler-key me-1 text-primary"></i> Password Baru
                                </label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small text-white" for="password_confirmation">
                                    <i class="ti tabler-key me-1 text-primary"></i> Konfirmasi Password Baru
                                </label>
                            ...
                            <div class="col-md-12">
                                ...
                                <select id="siswa_ids" name="siswa_ids[]" class="form-select select2" multiple data-placeholder="Pilih satu atau beberapa siswa...">
                                    @foreach($siswaOptions as $siswa)
                                        <option value="{{ $siswa->id }}" {{ in_array($siswa->id, old('siswa_ids', $selectedSiswaIds)) ? 'selected' : '' }}>
