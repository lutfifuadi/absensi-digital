    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function runBulkWaCheck(role) {
                ...
                Swal.fire({
                    title: 'Verifikasi WA Massal (Semua Orang Tua)',
                    html: `
                        <div class="mb-3 text-start">
                            <small class="text-white-50 d-block mb-2">Memeriksa keaktifan nomor WhatsApp seluruh data orang tua di database secara otomatis...</small>
