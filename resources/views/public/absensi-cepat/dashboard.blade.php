    ...
    <div class="flex-1 flex flex-col">
      ...
      <div x-show="activeTab === 'bulk'" class="flex-1 flex flex-col"
           x-data="{
             ...
             loadData() {
               if (!this.selectedKelas && !this.searchQuery) {
                 this.students = [];
                 return;
               }
               this.loading = true;
               const params = new URLSearchParams();
               if (this.selectedKelas) params.append('kelas_id', this.selectedKelas);
        ...
        <!-- Controls Header: Dual Filter (Pilih Kelas + Search Nama 3-Way) -->
            ...
            <div class="w-full sm:w-64">
              ...
              <div class="relative w-full">
                <select x-ref="selectKelas"
                        class="w-full h-10 bg-slate-950 border border-slate-800 rounded-[5px] text-xs font-semibold text-slate-100 outline-none">
        ...
        <div class="bg-slate-900/90 border border-slate-800 rounded-[5px] overflow-hidden flex-1 flex flex-col shadow-lg relative z-10">
          ...
          <div x-show="!loading && students.length === 0" class="flex-1 flex flex-col items-center justify-center py-12">
            ...
            <p class="text-[11px] text-slate-600 mt-0.5">Silakan pilih kelas atau ketik nama pada kolom pencarian.</p>
          </div>
