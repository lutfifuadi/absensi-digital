...
<body>
  <div class="authentication-wrapper">
    ...
    <div class="auth-form-wrapper">
      ...
      <form action="{{ route('public.pelepasan.auth') }}" method="POST">
        @csrf
        <div class="mb-4">
          <label for="kata_kunci" class="form-label">Kata Kunci Akses</label>
          <input id="kata_kunci" type="password" name="kata_kunci"
            class="form-control {{ $errors->has('kata_kunci') ? 'is-invalid' : '' }}"
            placeholder="Masukkan kata kunci..." autofocus autocomplete="current-password">
          @error('kata_kunci')
      ...
      <p class="footer-note">Kata kunci diatur oleh admin sekolah.</p>
    </div>
  </div>
</body>
</html>
