      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item mt-0"
            href="{{ Auth::check() && Auth::user()->role === 'orang_tua' ? route('ortu.pengaturan') : (Auth::check() && Auth::user()->role === 'siswa' ? route('siswa.profile') : (Route::has('profile.show') ? route('profile.show') : 'javascript:void(0);')) }}">
