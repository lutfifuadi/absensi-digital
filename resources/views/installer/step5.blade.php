        ...
        <div class="grid-2 mt-12">
            <div class="field">
                ...
                <div class="inp-wrap has-icon">
                    ...
                    <input type="text" name="admin_name" value="{{ old('admin_name', session('install_admin_name')) }}" placeholder="Nama Admin" required>
                </div>
            </div>
            <div class="field">
                ...
                <div class="inp-wrap has-icon">
                    ...
                    <input type="email" name="admin_email" value="{{ old('admin_email', session('install_admin_email')) }}" placeholder="admin@sekolah.com" required>
                </div>
            </div>
        </div>
        ...
        <div class="grid-2 mt-12">
            <div class="field">
                ...
                <div class="inp-wrap has-icon">
                    ...
                    <input type="text" name="admin_username" value="{{ old('admin_username', session('install_admin_username')) }}" placeholder="admin_sekolah" required>
                </div>
            </div>
            <div class="field">
                ...
                <div class="inp-wrap has-icon" style="position: relative;">
                    ...
                    <input type="password" name="admin_password" id="admin_password" placeholder="Min. 6 karakter" required style="padding-right: 36px;">
                    <span class="toggle-password" data-target="admin_password" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; color: var(--text-sub); display: flex; align-items: center; justify-content: center; opacity: 0.7; transition: opacity 0.2s;">
