      ...
      <div class="col-12 auth-right-panel">
        <div class="auth-form-wrapper">
          <div class="form-heading">
            <h4>Lupa Password? 🔒</h4>
            <p>Masukkan email Anda dan kami akan mengirimkan instruksi untuk mengatur ulang kata sandi Anda</p>
          </div>
          ...
          <form id="formAuthentication" action="{{ route('password.email') }}" method="POST">
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                placeholder="contoh@sekolah.sch.id" autofocus value="{{ old('email') }}" />
              @error('email')
                <span class="invalid-feedback" role="alert"><span class="fw-medium">{{ $message }}</span></span>
              @enderror
            </div>

            <button class="btn btn-signin" type="submit">Kirim Link Reset</button>
          </form>
