...
<div class="dash-wrapper">
  ...
  <div class="glass-card section-gap anim anim-d3">
    <div class="chart-card-header d-flex justify-content-between align-items-center">
      <div>
        <p class="chart-title text-danger">
          <i class="ti tabler-shield-alert" style="color:var(--accent-red);"></i>
          Siswa dengan Poin Pelanggaran Tertinggi
        </p>
        <p class="chart-sub">Top 5 Pelanggaran Tahun Akademik Aktif</p>
      </div>
    </div>
