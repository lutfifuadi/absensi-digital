...
- **UI Notifikasi Update**: Memperbarui desain alert "Versi Baru Tersedia" agar lebih mencolok dan elegan. Menggunakan gradient ungu-indigo, efek glassmorphism (backdrop blur), shadow lembut, serta animasi pulse pada ikon untuk meningkatkan visibilitas tanpa mengganggu estetika layout.
